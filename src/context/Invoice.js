...
import autoTable from 'jspdf-autotable'; // ✅ সঠিক ইম্পোর্ট

export const generateInvoicePDF = (order) => {
  console.log('📄 generateInvoicePDF called with order:', order?.id);
  ...
  try {
    ...
    // ✅ Items Table - autoTable ব্যবহার করুন
